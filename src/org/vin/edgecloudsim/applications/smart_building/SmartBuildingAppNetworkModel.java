...
public class SmartBuildingAppNetworkModel extends NetworkModel {
    ...
    // Public Constructor
    public SmartBuildingAppNetworkModel(int _numberOfSensors, String _simScenario) {
        super(_numberOfSensors, _simScenario);
    }
