...
import org.vin.edgecloudsim.edge_client.mobile_process_unit.MobileHost;
...
import org.vin.edgecloudsim.edge_client.mobile_process_unit.MobileVmAllocationPolicy_Custom;

import java.util.ArrayList;
import java.util.LinkedList;
import java.util.List;

public class SmartBuildingAppServerManager extends MobileServerManager {
    private int numOfSensors = 0;

    public SmartBuildingAppServerManager(int _numOfSensors) {
