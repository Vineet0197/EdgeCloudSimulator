...
import org.vin.edgecloudsim.edge_server.EdgeHost;
...
public class MM1Queue extends NetworkModel {
    ...
    public MM1Queue(int _numberOfSensorDevices, String _simScenario) {
        super(_numberOfSensorDevices, _simScenario);
    }
